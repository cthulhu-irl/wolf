...
struct w_lz4 {
   ...
   */
  W_API [[maybe_unused]] static int get_compress_bound(
      _In_ int p_size) noexcept;
   ...
   */
  W_API static boost::leaf::result<std::vector<std::byte>> compress_default(
      _In_ const gsl::span<const std::byte> p_src) noexcept;
   ...
   * @returns the vector of compressed stream
   */
  W_API static boost::leaf::result<std::vector<std::byte>> compress_fast(
   ...
   */
  W_API static boost::leaf::result<std::vector<std::byte>> decompress(
      _In_ const gsl::span<const std::byte> p_src,
