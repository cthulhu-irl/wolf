...
/*!
        The function appends the input as input content to the end of the text
   file.
        ...
        \return (void)
*/
W_API auto write_in_file_append(_In_ std::string pFilePath,
                                _In_ std::string pContent) -> void;
