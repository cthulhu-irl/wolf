...
class w_nud_det {
  ...
  */
  ...
  /*!
  The function gets a string as input and return the boolean representation of
  the input.
  ...
  nudity factors.
  */
  W_API auto nudity_detection(_In_ uint8_t* pImageData, _In_ int pImageWidth,
                              _In_ int pImageHeight, _In_ int pImageChannels)
      -> std::vector<float>;
