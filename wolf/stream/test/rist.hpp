...
//
//    const auto new_msg = std::string_view(gsl::narrow_cast<const char
//    *>(std::get<0>(_new_block)),
...
//          auto _sender =
//              w_rist(rist_ctx_mode::RIST_SENDER_MODE, _mode, _loss,
...
//
//          for (;;) {
//            std::string _msg = "hello from RIST stream: #" +
//            std::to_string(_index++); const auto _block =
...
//
//    auto _receiver =
//        w_rist(rist_ctx_mode::RIST_RECEIVER_MODE, _mode, _loss,
//        rist_log_level::RIST_LOG_DEBUG);
//    auto _ret = _receiver.init();
//    BOOST_REQUIRE(_ret.has_error() == false);
//
//    _receiver.on_receiver_data_callback = [](_In_ const w_rist_data_block
//    &p_data_block) {
